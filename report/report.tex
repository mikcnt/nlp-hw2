...
\begin{document}
	...
	BERT as an embedding layer, as suggested in \citep{li2019exploiting}. Differently
	...
	layer to work just better. In fact, removing the BERT embeddings and relying	only on context-free embeddings given by GloVe, the CRF starts to shine, increasing the performances of the baseline model to from 0.381 to 0.391.
